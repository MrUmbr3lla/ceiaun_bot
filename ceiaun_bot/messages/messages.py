...
CONVERT_NAME_RESULT = """نام درس با موفقیت تغییر کرد ✅

نام درس تغییریافته:
{result}

در صورتی که قصد تغییر نام دروس دیگر را دارید، نام آن دروس را وارد نمایید یا از گزینه «برگشت» استفاده کنید:"""
